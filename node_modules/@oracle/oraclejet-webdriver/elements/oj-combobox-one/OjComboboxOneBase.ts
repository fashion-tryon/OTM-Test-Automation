...
/**
 * This is the base class for OjComboboxOne, and is generated from
...
export class OjComboboxOneBase extends OjWebElement {
   ...
   * 
   */
  public getDisplayOptions(): Promise<OjComboboxOneBase.DisplayOptions> {
    return this.getProperty<OjComboboxOneBase.DisplayOptions>("displayOptions");
  }

  /**
   * Gets the value of filterOnOpen property.
   * Whether to filter the drop down list on open.
   * @return The value of filterOnOpen property.
   * 
   */
   ...
   * 
   */
  public getHelp(): Promise<OjComboboxOneBase.Help> {
    return this.getProperty<OjComboboxOneBase.Help>("help");
  }
   ...
   * 
   */
  public getHelpHints(): Promise<OjComboboxOneBase.HelpHints> {
    return this.getProperty<OjComboboxOneBase.HelpHints>("helpHints");
  }
  ...
  /**
   * Gets the value of maximumResultCount property.
   * The maximum number of results displayed in the dropdown.
   * @return The value of maximumResultCount property.
   * 
   */
  ...
  /**
   * Gets the value of optionRenderer property.
   * The renderer function that renders the content of each option.
   * @return The value of optionRenderer property.
   * 
   */
  ...
  /**
   * Gets the value of optionsKeys property.
   ...
   * @return The value of optionsKeys property.
   * 
   */
  public getOptionsKeys(): Promise<OjComboboxOneBase.OptionsKeys> {
    return this.getProperty<OjComboboxOneBase.OptionsKeys>("optionsKeys");
  }
   ...
   * 
   */
  public getPickerAttributes(): Promise<OjComboboxOneBase.PickerAttributes> {
    return this.getProperty<OjComboboxOneBase.PickerAttributes>("pickerAttributes");
  }
   ...
   * 
   */
  public getTranslations(): Promise<OjComboboxOneBase.Translations|null> {
    return this.getProperty<OjComboboxOneBase.Translations|null>("translations");
  }
  ...
  /**
   * Sets the value of "valueOption" property.
   * The current value of the element and its associated display label.
   * @param valueOption The value to set for "valueOption"
   * 
   */
  public changeValueOption(valueOption: null|OjComboboxOneBase.ValueOption): Promise<void> {
    return this.setProperty<null|OjComboboxOneBase.ValueOption>("valueOption", valueOption);
  }

  /**
   * Gets the value of valueOption property.
   * The current value of the element and its associated display label.
   * @return The value of valueOption property.
   * 
   */
  public getValueOption(): Promise<null|OjComboboxOneBase.ValueOption> {
    return this.getProperty<null|OjComboboxOneBase.ValueOption>("valueOption");
  }

}

namespace OjComboboxOneBase {
  ...
  export interface OptionsKeys {
     ...
     */
    "childKeys": OjComboboxOneBase.OptionsKeysChildKeys;
    /**
  ...
  export interface OptionsKeysChildKeys {
     ...
     */
    "childKeys": OjComboboxOneBase.OptionsKeysChildKeysChildKeys;
    /**
  ...
  export interface Translations {
     ...
     */
    "required": OjComboboxOneBase.TranslationsRequired;
  }
