...
/**
 * This is the base class for OjSelectMany, and is generated from
...
export class OjSelectManyBase extends OjWebElement {
   ...
   * 
   */
  public getDisplayOptions(): Promise<OjSelectManyBase.DisplayOptions> {
    return this.getProperty<OjSelectManyBase.DisplayOptions>("displayOptions");
  }
   ...
   * 
   */
  public getHelp(): Promise<OjSelectManyBase.Help> {
    return this.getProperty<OjSelectManyBase.Help>("help");
  }
   ...
   * 
   */
  public getHelpHints(): Promise<OjSelectManyBase.HelpHints> {
    return this.getProperty<OjSelectManyBase.HelpHints>("helpHints");
  }
  ...
  /**
   * Gets the value of minimumResultsForSearch property.
   * The threshold for showing the search box in the dropdown.
   * @return The value of minimumResultsForSearch property.
   * 
   */
   ...
   * 
   */
  public getOptionsKeys(): Promise<OjSelectManyBase.OptionsKeys> {
    return this.getProperty<OjSelectManyBase.OptionsKeys>("optionsKeys");
  }
   ...
   * 
   */
  public getPickerAttributes(): Promise<OjSelectManyBase.PickerAttributes> {
    return this.getProperty<OjSelectManyBase.PickerAttributes>("pickerAttributes");
  }
   ...
   * 
   */
  public getTranslations(): Promise<OjSelectManyBase.Translations|null> {
    return this.getProperty<OjSelectManyBase.Translations|null>("translations");
  }
  ...
  /**
   * Sets the value of "valueOptions" property.
   * The current values of the element and their associated display labels.
   * @param valueOptions The value to set for "valueOptions"
   * 
   */
  public changeValueOptions(valueOptions: null|Array<OjSelectManyBase.ValueOptions>): Promise<void> {
    return this.setProperty<null|Array<OjSelectManyBase.ValueOptions>>("valueOptions", valueOptions);
  }

  /**
   * Gets the value of valueOptions property.
   * The current values of the element and their associated display labels.
   * @return The value of valueOptions property.
   * 
   */
  public getValueOptions(): Promise<null|Array<OjSelectManyBase.ValueOptions>> {
    return this.getProperty<null|Array<OjSelectManyBase.ValueOptions>>("valueOptions");
  }

}

namespace OjSelectManyBase {
  ...
  export interface OptionsKeys {
     ...
     */
    "childKeys": OjSelectManyBase.OptionsKeysChildKeys;
    /**
  ...
  export interface Translations {
     ...
     */
    "required": OjSelectManyBase.TranslationsRequired;
    /**
