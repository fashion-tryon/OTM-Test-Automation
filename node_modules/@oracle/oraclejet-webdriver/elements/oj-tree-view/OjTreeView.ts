...
/**
 * This is the component WebElement for oj-tree-view. Retrieve an instance of the class
 * using its convenience function:
 * ```javascript
 * await ojTreeView(driver, By.css('oj-tree-view'))
 * ```
 */
  ...
  */
  private async _isExpanded(itemContent: SlotProxy): Promise<boolean> {
    ...
    return driver.executeScript<boolean>(
      "return arguments[0].parentNode.parentNode.classList.contains('oj-expanded')", ins);
  }
  /**
