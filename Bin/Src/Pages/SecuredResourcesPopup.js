...
exports.SecuredResourcesPopup = void 0;
const selenium_webdriver_1 = require("selenium-webdriver");
const Popup_1 = require("../util/Popup");
class SecuredResourcesPopup extends Popup_1.Popup {
    constructor() {
        super(...arguments);
        this.sTitle = "Secure Resources";
...
exports.SecuredResourcesPopup = SecuredResourcesPopup;
