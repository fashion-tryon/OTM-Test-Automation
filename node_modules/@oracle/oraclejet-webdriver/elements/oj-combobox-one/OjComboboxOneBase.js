...
exports.OjComboboxOneBase = void 0;
const __1 = require("../");
class OjComboboxOneBase extends __1.OjWebElement {
    getAsyncValidators() {
    ...
    getFilterOnOpen() {
        return this.getProperty("filterOnOpen");
    }
    getHelp() {
    ...
    changeValueOption(valueOption) {
        return this.setProperty("valueOption", valueOption);
    }
    getValueOption() {
        return this.getProperty("valueOption");
    }
}
exports.OjComboboxOneBase = OjComboboxOneBase;
//# sourceMappingURL=OjComboboxOneBase.js.map