...
exports.OjSelectManyBase = void 0;
const __1 = require("../");
class OjSelectManyBase extends __1.OjWebElement {
    getDescribedBy() {
    ...
    getMaximumResultCount() {
        return this.getProperty("maximumResultCount");
    }
    ...
    getMinimumResultsForSearch() {
        return this.getProperty("minimumResultsForSearch");
    }
    getOptionRenderer() {
    ...
    changeValueOptions(valueOptions) {
        return this.setProperty("valueOptions", valueOptions);
    }
    getValueOptions() {
        return this.getProperty("valueOptions");
    }
}
exports.OjSelectManyBase = OjSelectManyBase;
//# sourceMappingURL=OjSelectManyBase.js.map