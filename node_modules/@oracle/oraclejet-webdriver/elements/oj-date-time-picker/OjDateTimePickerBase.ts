...
/**
 * This is the base class for OjDateTimePicker, and is generated from
...
export class OjDateTimePickerBase extends OjWebElement {
   ...
   * 
   */
  public getDatePicker(): Promise<OjDateTimePickerBase.DatePicker> {
    return this.getProperty<OjDateTimePickerBase.DatePicker>("datePicker");
  }
   ...
   * 
   */
  public getDisplayOptions(): Promise<OjDateTimePickerBase.DisplayOptions> {
    return this.getProperty<OjDateTimePickerBase.DisplayOptions>("displayOptions");
  }
   ...
   * 
   */
  public getHelp(): Promise<OjDateTimePickerBase.Help> {
    return this.getProperty<OjDateTimePickerBase.Help>("help");
  }
   ...
   * 
   */
  public getHelpHints(): Promise<OjDateTimePickerBase.HelpHints> {
    return this.getProperty<OjDateTimePickerBase.HelpHints>("helpHints");
  }
   ...
   * 
   */
  public getPickerAttributes(): Promise<OjDateTimePickerBase.PickerAttributes> {
    return this.getProperty<OjDateTimePickerBase.PickerAttributes>("pickerAttributes");
  }
   ...
   * 
   */
  public getTimePicker(): Promise<OjDateTimePickerBase.TimePicker> {
    return this.getProperty<OjDateTimePickerBase.TimePicker>("timePicker");
  }
   ...
   * 
   */
  public getTranslations(): Promise<OjDateTimePickerBase.Translations|null> {
    return this.getProperty<OjDateTimePickerBase.Translations|null>("translations");
  }
...
namespace OjDateTimePickerBase {
  ...
  export interface Translations {
     ...
     */
    "dateRestriction": OjDateTimePickerBase.TranslationsDateRestriction;
    /**
     ...
     */
    "dateTimeRange": OjDateTimePickerBase.TranslationsDateTimeRange;
    /**
     ...
     */
    "regexp": OjDateTimePickerBase.TranslationsRegexp;
    /**
     ...
     */
    "required": OjDateTimePickerBase.TranslationsRequired;
    /**
  ...
  export interface TranslationsDateTimeRange {
     ...
     */
    "hint": OjDateTimePickerBase.TranslationsDateTimeRangeHint;
    /**
     ...
     */
    "messageDetail": OjDateTimePickerBase.TranslationsDateTimeRangeMessageDetail;
    /**
     ...
     */
    "messageSummary": OjDateTimePickerBase.TranslationsDateTimeRangeMessageSummary;
  }
