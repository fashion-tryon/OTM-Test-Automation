...
import {OjComboboxOneBase} from "./OjComboboxOneBase";

/**
 * This is the component WebElement for oj-combobox-one. Retrieve an instance of the class
 * using its convenience function:
 * ```javascript
 * await ojComboboxOne(driver, By.css('oj-combobox-one'))
 * ```
 */
export class OjComboboxOne extends OjComboboxOneBase {
  /**
  ...
  async clear(): Promise<void> {
    const input = await this.findElement(By.css(".oj-combobox-input"));
    await input.clear();
