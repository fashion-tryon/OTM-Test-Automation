 ...
 * runner's. This is typically done in the setup test.
 *
 * ### Set WebDriver timeout to 5 seconds sooner than Mocha
 * ```javascript
 * const mochaTimeout = this.timeouts();
 * const wdTimeout = mochaTimeout - 5000;
 * DriverManager.registerConfig({
 *   timeouts: {
 *     pageLoad: wdTimeout,
 *     script: wdTimeout,
...
export class DriverManager {
   ...
   */
  public static getDriver(configName?: string): Promise<WebDriver> {
