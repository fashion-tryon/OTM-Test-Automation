...
/**
 * This is the base class for OjDatePicker, and is generated from
...
export class OjDatePickerBase extends OjWebElement {
   ...
   * 
   */
  public getDatePicker(): Promise<OjDatePickerBase.DatePicker> {
    return this.getProperty<OjDatePickerBase.DatePicker>("datePicker");
  }
   ...
   * 
   */
  public getDisplayOptions(): Promise<OjDatePickerBase.DisplayOptions> {
    return this.getProperty<OjDatePickerBase.DisplayOptions>("displayOptions");
  }
   ...
   * 
   */
  public getHelp(): Promise<OjDatePickerBase.Help> {
    return this.getProperty<OjDatePickerBase.Help>("help");
  }
   ...
   * 
   */
  public getHelpHints(): Promise<OjDatePickerBase.HelpHints> {
    return this.getProperty<OjDatePickerBase.HelpHints>("helpHints");
  }
   ...
   * The maximum selectable date, in ISO string format. When set to null, there is no maximum. min and max must be in the same ISO string format as value (local, zulu, or offset).
   ...
   * The minimum selectable date, in ISO string format. When set to null, there is no minimum. min and max must be in the same ISO string format as value (local, zulu, or offset).
   ...
   * 
   */
  public getPickerAttributes(): Promise<OjDatePickerBase.PickerAttributes> {
    return this.getProperty<OjDatePickerBase.PickerAttributes>("pickerAttributes");
  }
   ...
   * 
   */
  public getTranslations(): Promise<OjDatePickerBase.Translations|null> {
    return this.getProperty<OjDatePickerBase.Translations|null>("translations");
  }
...
namespace OjDatePickerBase {
  ...
  export interface Translations {
     ...
     */
    "dateRestriction": OjDatePickerBase.TranslationsDateRestriction;
    /**
     ...
     */
    "dateTimeRange": OjDatePickerBase.TranslationsDateTimeRange;
    /**
     ...
     */
    "regexp": OjDatePickerBase.TranslationsRegexp;
    /**
     ...
     */
    "required": OjDatePickerBase.TranslationsRequired;
    /**
  ...
  export interface TranslationsDateTimeRange {
     ...
     */
    "hint": OjDatePickerBase.TranslationsDateTimeRangeHint;
    /**
     ...
     */
    "messageDetail": OjDatePickerBase.TranslationsDateTimeRangeMessageDetail;
    /**
     ...
     */
    "messageSummary": OjDatePickerBase.TranslationsDateTimeRangeMessageSummary;
  }
